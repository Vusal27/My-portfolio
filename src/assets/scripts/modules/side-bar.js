function sidebarfunc() {
    // var elem = document.querySelector('.blog__content');
    // var texts = document.querySelectorAll('.article');
    // var links = document.querySelectorAll('.js-composition__item');
    // var windows = document.querySelector('.parallax');
    // var textsOffset = [];

    // texts.forEach(function(article){
    //     textsOffset.push(article.offsetTop);	
    // });
    ...
    //                 el.classList.remove('composition__item--activ');
    //             })
    //             links[i].classList.add('composition__item--activ');
    //         } 
    //     })
    // })
    ...
    const nav = document.querySelector('.js-blog__list');
    const navList = nav.querySelector('.js-composition');
    const navBtn = nav.getElementsByClassName('js-composition__item');
    const articlesList = document.getElementsByClassName('js-articles');
    const articles = document.querySelectorAll('.js-article');
    const activeBtnClass = 'composition__item--activ'; // Класс для стилизации активной кнопки
    const speed = .8; // Скорость скроллинга до статьи
